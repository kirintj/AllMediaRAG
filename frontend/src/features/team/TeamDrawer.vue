...
<template>
  <div v-if="open" class="fixed inset-0 z-50 flex justify-end">
    ...
    <div class="relative w-[420px] bg-white dark:bg-gray-900 shadow-xl flex flex-col h-full">
      <!-- Header -->
      <div class="flex items-center justify-between p-4 border-b">
        <div class="flex items-center gap-2">
          ...
          <span v-if="pendingCount > 0"
                class="ml-1 px-1.5 py-0.5 text-[10px] font-bold bg-yellow-500 text-white rounded-full">
            {{ pendingCount }}
          </span>
        </div>
        ...
        <div>
          ...
          <div class="space-y-2">
            <div v-for="member in members" :key="member.user_id"
              ...
              <div class="flex items-center gap-2">
                <!-- Role selector for non-owner active members -->
