  ...
  <div class="flex flex-col h-full">
    ...
    <div v-if="searchOpen" class="px-3 pt-2 pb-1 flex-shrink-0">
      <div class="relative">
        ...
        <input
          ...
          type="text"
          placeholder="搜索对话..."
          class="w-full h-8 pl-8 pr-3 text-sm rounded-md bg-muted border-0 outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground"
    ...
    <div class="flex-shrink-0 border-t border-border px-3 py-2">
      <div class="flex items-center justify-between">
        ...
        <button
          class="h-7 w-7 flex items-center justify-center rounded-md hover:bg-accent text-muted-foreground hover:text-foreground transition-colors flex-shrink-0"
          @click="theme.toggle()"
...
import { Search, Plus, Cpu, Sun, Moon } from 'lucide-vue-next'
